...
<section class="hero">
      <div class="hero__slider owl-carousel">
          @foreach($images_banner as $image_banner)
              <div class="hero__items set-bg" data-setbg="{{asset('img/image-bg/'.$image_banner->url)}}">
                  <div class="container">
                      <div class="row">
                ...
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="{{asset('img/image-product/'.$images_top_3_best_sell[0]->image)}}" alt="">
                        </div>
            ...
            @if(isset($images_top_3_best_sell[1]))
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="{{asset('img/image-product/'.$images_top_3_best_sell[1]->image)}}" alt="">
                        </div>
                        <div class="banner__item__text">
            ...
            @if(isset($images_top_3_best_sell[2]))
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        <div class="banner__item__pic">
                            <img src="{{asset('img/image-product/'.$images_top_3_best_sell[2]->image)}}" alt="">
                        </div>
                        <div class="banner__item__text">
